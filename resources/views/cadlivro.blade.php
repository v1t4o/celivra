    ...
    <body>
        <div class="container">
            ...
            <div id="corpo" class="row">
                <form id="cadastro" method="post" action="/livro/salvar">
                    <h2 style="text-align:center;color:#3f8cff">Cadastro de Livro</h2>
                    @csrf
                    <div class="form-row">
                        <div class="form-group col">
                            <label for="inputText">Título</label>
                            <input name="titulo" type="text" class="form-control" id="inputText" placeholder="Título do Livro">
                        </div>
                        <div class="form-group col">
                            <label for="inputText">Autor</label>
                            <input name="autor" type="text" class="form-control" id="inputText" placeholder="Autor do Livro">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="inputText">Ano de Publicação</label>
                            <input name="ano" type="text" class="form-control" id="inputText" placeholder="Ano de publicação do Livro">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputText">Edição</label>
                            <input name="edicao" type="text" class="form-control" id="inputText" placeholder="Edição do Livro">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputText">Editora</label>
                            <input name="editora" type="text" class="form-control" id="inputText" placeholder="Editora do Livro">
                        </div>
                    </div>
                    <div class="form-row">        
                        <div class="form-group col">
                            <label for="inputText">ISBN</label>
                            <input name="isbn" type="text" class="form-control" id="inputText" placeholder="ISBN do Livro">
                        </div>
                        <div class="form-group col">
                            <label for="inputText">Quantidade de páginas</label>
                            <input name="numpaginas" type="text" class="form-control" id="inputText" placeholder="Quantidade de páginas do Livro">
                        </div>
                        <div class="form-group col">
                            <label for="inputText">Quantidade de Item</label>
                            <input name="quantidade" type="text" class="form-control" id="inputText" placeholder="Quantidade a ser cadastrada">
                        </div>
                        <div class="form-group col">
                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            ...
                            <input name="descritem" type="text" class="form-control" id="inputText" placeholder="Descrição do Livro">
                        </div>
                    </div>
